  ...
  return (
    <section className="w-full py-20 px-4 text-center relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        >
          Your gateway to intelligent cryptocurrency trading and market
          analysis. Get real-time insights, advanced analytics, and make
...
export default function HomePage() {
  ...
  const features = [
    {
      ...
      description:
        "Access real-time market data, technical indicators, and AI-powered insights.",
    },
    {
      icon: <Shield className="h-10 w-10 text-purple-600" />,
      title: "Top-Tier Security",
      description:
        "Your assets are protected with bank-level encryption and multi-factor authentication.",
    },
    {
      icon: <Zap className="h-10 w-10 text-yellow-600" />,
      title: "Lightning-Fast Trades",
      description:
        "Execute orders in milliseconds on our high-performance trading engine.",
    },
    {
  ...
  const testimonials = [
    {
      quote:
        "CryptoVision transformed my trading strategy. The analytics are unparalleled!",
      author: "Jane Doe, Professional Trader",
    },
    {
      quote:
        "Secure, fast, and incredibly user-friendly. Highly recommend for anyone in crypto.",
      author: "John Smith, Crypto Enthusiast",
    },
    {
      quote:
        "The best platform for real-time insights. My portfolio has never looked better.",
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-md">
                ...
                <p className="text-slate-600">
                  Sign up in minutes with your email and verify your identity.
                </p>
              </div>
              <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-md">
                ...
                <p className="text-slate-600">
                  Deposit crypto or fiat currency securely to your CryptoVision
                  wallet.
                </p>
              </div>
              <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-md">
                ...
                <p className="text-slate-600">
                  Explore markets, analyze data, and execute your first trade.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto max-w-6xl text-center">
            ...
            <div className=" p-8 rounded-lg shadow-lg border">
              ...
              <p className="text-sm text-slate-500 mt-6">
                *Data is for demonstration purposes only and not real-time.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <p className="text-xl text-slate-600 mb-8 max-w-2xl mx-auto">
              Join CryptoVision today and take control of your digital assets
              with confidence.
            </p>
